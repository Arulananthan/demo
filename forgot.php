...
<!-- <form class="modal-content animate" action="" method="post" enctype="multipart/form-data"> -->
  <form class="modal-content animate" action="" method="post" enctype="multipart/form-data" autocomplete="off">
    ...
    <div class="container">
      ...
      <label for="psw"><b>New Password</b><span class="require">*</span></label>
      <input type="password" placeholder="Enter Password" name="psw" required>

      <label for="psw"><b>Conform Password</b><span class="require">*</span></label>
...
$login = mysqli_query($con,"select * from login where email ='".$_POST['email']."'" );
while($row = mysqli_fetch_array($login)){
   $id = $row["id"];

  $forgot = mysqli_query($con,"UPDATE `login` SET `password` = '".$_POST['psw']."', `cpassword` = '".$_POST['cpsw']."' where id = $id");
  if($forgot){
    ?>

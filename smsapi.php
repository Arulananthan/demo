...
<body>
  ...
  if(isset($_POST["submit"])){
    ...
    curl_setopt_array($curl, array(
      ...
      CURLOPT_POSTFIELDS => "<MESSAGE> <AUTHKEY>YOUR API KEY</AUTHKEY><UNICODE>1</UNICODE> <SENDER>API user name</SENDER> <ROUTE>4</ROUTE> <CAMPAIGN>TRIAL</CAMPAIGN> <COUNTRY>country code</COUNTRY> <SMS TEXT=\"hi\" > <ADDRESS TO=\"your phone no\"></ADDRESS> <ADDRESS TO=\"+phone_nos\"></ADDRESS> </SMS> <SMS TEXT=\"TEXT\" > </SMS> </MESSAGE>",
